// client/src/components/DepositHistoryBlock.js
...
const DepositHistory = () => {
    ...
    const exportToCSV = () => {
        ...
        const headers = ['depositType', 'depositAmount', 'termYears', 'totalAmount', 'interest']
        const csvContent = [
            headers.join(';'),
        ...
        link.download = 'deposit_history_export_' + timestamp + '.csv'
                ...
                <>
                    ...
                    <ul className="history-list">
                        {historyData.map((line) => (
                            <li key={line._id}>
                                {line.depositType}, {line.depositAmount}, {line.termYears}, {line.totalAmount}, {line.interest}
                            </li>
                        ))}
                    </ul>
                    <div className="wrapper">
